...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PX");
    case mBTC: return QString("mPEX");
    case uBTC: return QString::fromUtf8("μPEX");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("PX");
    case mBTC: return QString("Milli-PX (1 / 1,000)");
    case uBTC: return QString("Micro-PX (1 / 1,000,000)");
    default: return QString("???");
    }
}
