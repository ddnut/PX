...
{
    resize(850, 550);
    setWindowTitle(tr("PX Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/PEX_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PX address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/PEX_tooltip"), tr("&About PX"), this);
    aboutAction->setToolTip(tr("Show information about PX"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PX"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/PEX_tooltip"), tr("Show/Hide &PX"), this);
    toggleHideAction->setToolTip(tr("Show or hide the PX window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/PEX_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/PEX_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/PEX_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PX client"));
    trayIcon->setIcon(QIcon(":/icons/PEX_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PX network", "", count));
}
