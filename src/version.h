...
// PX version - intended for display purpose only
#define PX_VERSION_MAJOR       3
#define PX_VERSION_MINOR       0
#define PX_VERSION_REVISION    0
#define PX_VERSION_BUILD       0

static const int PX_VERSION =
                           1000000 * PX_VERSION_MAJOR
                         +   10000 * PX_VERSION_MINOR
                         +     100 * PX_VERSION_REVISION
                         +       1 * PX_VERSION_BUILD;

// PX version - reference for code tracking
