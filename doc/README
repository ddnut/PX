PX 0.1.2
Copyright (c) 2014 PX developers
...
About PX
---------------
PX is a PX network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the PX reference
wallet (http://github.com/PX/PX). 

To help faciliate broad community cooperation, a number of trusted 
PX/Peershares community leaders have write permissions to the project's 
...
Resources
---------
PX source code: https://github.com/PX/PX

For the most current instructions covering how to compile PX from 
source on a variety of operating systems, please visit:
https://github.com/PX/PX/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/PX/PX/issues?state=open

PX discussion forums (hosted by PEXTalk.org): 
http://www.PEXtalk.org/index.php?board=64.0



Acknowledgements
----------------
PX owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:
	...
	PX is a free open source project with the goal of providing a 
